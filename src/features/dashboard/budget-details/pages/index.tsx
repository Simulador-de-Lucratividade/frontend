                ...
                <Col xs={24} sm={16} md={18} lg={19}>
                  ...
                  >
                    <div>
                      ...
                      >
                        Orçamento #{mockBudgetData.id}
                      </Title>
                      <Space size="small" wrap>
                        <Tag color={getStatusColor(mockBudgetData.status)}>
                          {getStatusLabel(mockBudgetData.status)}
                        </Tag>
                        <Tag color="blue">{mockBudgetData.client.name}</Tag>
                      </Space>
                    </div>
                    ...
                    <Space size="large" wrap>
                      <Space size="small">
                        <CalendarOutlined />
                        <Text>Criado em: {mockBudgetData.createdAt}</Text>
                      </Space>
                      <Space size="small">
                        <LockOutlined />
                        <Text>Válido até: {mockBudgetData.validUntil}</Text>
                      </Space>
                    </Space>
                  </Space>
                </Col>
                  ...
                  <Space direction="vertical" size="middle" className="w-full">
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <Text strong>{mockBudgetData.client.name}</Text>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <Text strong>{mockBudgetData.client.contact}</Text>
                      </div>
                    </div>
