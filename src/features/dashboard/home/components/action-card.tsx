...
export const ActionCard: React.FC<CardProps> = ({ title, icon }) => {
  return (
    <div className="group w-full h-full bg-white border border-borderSecondary rounded-2xl p-4 sm:p-5 cursor-pointer transition-all duration-300 hover:shadow-lg hover:border-primary/10 hover:scale-[1.02]">
